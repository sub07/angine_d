...
private import glad.funcs;
private import glad.ext;
private import glad.enums;
private import glad.types;
...
private {
	...
	void find_coreGL() {
		...
		const(char)*[] prefixes = [
			"OpenGL ES-CM ".ptr, "OpenGL ES-CL ".ptr, "OpenGL ES ".ptr,
		];
	...
	void load_GL_VERSION_4_0(Loader load) {
		...
		glBlendEquationSeparatei = cast(typeof(glBlendEquationSeparatei)) load(
	...
	void load_GL_VERSION_4_5(Loader load) {
		...
		glGetnCompressedTexImage = cast(typeof(glGetnCompressedTexImage)) load(
		...
		glGetnConvolutionFilter = cast(typeof(glGetnConvolutionFilter)) load(
	...
	void load_GL_VERSION_4_6(Loader load) {
		...
		glMultiDrawArraysIndirectCount = cast(typeof(glMultiDrawArraysIndirectCount)) load(
				"glMultiDrawArraysIndirectCount");
		glMultiDrawElementsIndirectCount = cast(typeof(glMultiDrawElementsIndirectCount)) load(
