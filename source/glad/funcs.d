...
nothrow @nogc extern (System) {
    ...
    alias fp_glCopyImageSubData = void function(GLuint, GLenum, GLint, GLint, GLint,
    ...
    alias fp_glCompressedTextureSubImage3D = void function(GLuint, GLint, GLint,
            GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const(void)*);
    ...
    alias fp_glGetnSeparableFilter = void function(GLenum, GLenum, GLenum,
    ...
    alias fp_glSpecializeShader = void function(GLuint, const(GLchar)*,
            GLuint, const(GLuint)*, const(GLuint)*);
    alias fp_glMultiDrawArraysIndirectCount = void function(GLenum,
            const(void)*, GLintptr, GLsizei, GLsizei);
    alias fp_glMultiDrawElementsIndirectCount = void function(GLenum, GLenum,
            const(void)*, GLintptr, GLsizei, GLsizei);
